...
func init() {
	...
	flow.Send.MarkFlagRequired("mode")
	flow.Send.MarkFlagRequired("host")
	flow.Send.MarkFlagRequired("payload")
	flow.Send.MarkFlagRequired("port")
	flow.Send.MarkFlagRequired("depth")
	// Auto flags
	...
	flow.Auto.MarkFlagRequired("mode")
	flow.Auto.MarkFlagRequired("host")
	flow.Auto.MarkFlagRequired("depth")
	// DDos flags
	...
	flow.DDOS.MarkFlagRequired("mode")
	flow.DDOS.MarkFlagRequired("host")
	flow.DDOS.MarkFlagRequired("port")
	// Server flags
	...
	strategy.Server.MarkFlagRequired("mode")
	strategy.Server.MarkFlagRequired("host")
	// Snmp flags
	strategy.Snmp.Flags().StringVarP(&utils.Config.Host, "host", "H", "0.0.0.0", "Host载体")
	strategy.Snmp.MarkFlagRequired("host")
